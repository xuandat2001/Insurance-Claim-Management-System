...
//    public abstract double calcInsuranceFee();
    public boolean create() {
        ...
        System.out.println("Set the ID(username): ");
        String userName = scanner.nextLine();
        System.out.println("Set the password : ");
        String password = scanner.nextLine();
        System.out.println("Set the full name : ");
        String fullName = scanner.nextLine();
        System.out.println("Set the Location : ");
        String location = scanner.nextLine();
        System.out.println("Set the Insurance Fee : ");
...
//        SessionFactory sessionFactory = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
        ...
        policyOwner.setInsuranceFee(insuranceFee);
...
//        SessionFactory sessionFactory = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
        ...
        try {
            ...
            for (PolicyOwner policyOwner : policyOwnerList) {
                ...
                System.out.println("Insurance Fee " + policyOwner.getInsuranceFee());
            }
